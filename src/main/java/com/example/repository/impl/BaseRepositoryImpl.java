...
import com.example.repository.transformer.UnderscoreToCamelTransformer;
...
public class BaseRepositoryImpl<T, ID extends Serializable> extends SimpleJpaRepository<T, ID> implements BaseRepository<T, ID> {
    ...
    private <R> List<R> queryBySql(String sql, Pageable pageable, Map<String, Object> params, Class<R> clazz) throws InstantiationException, IllegalAccessException {
